 ...
 * @class $N.platform.input.KeyMap_OpenTVRefOS
...
define('jsfw/platform/input/KeyMap_OpenTVRefOS',
	...
	function (BaseKeyMap) {
		...
		KeyMap_OpenTVRefOS.prototype = new $N.platform.input.BaseKeyMap();

		window.$N = $N || {};
		$N.platform = $N.platform || {};
		$N.platform.input = $N.platform.input || {};
		$N.platform.input.KeyMap_OpenTVRefOS = KeyMap_OpenTVRefOS;
		return KeyMap_OpenTVRefOS;
	}
);