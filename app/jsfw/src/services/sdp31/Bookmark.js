...
define('jsfw/services/sdp/Bookmark',
	...
	function (Log, ServiceFactory) {
		 ...
		 */
		Bookmark.getBookmarkForContent = function (contentId, contentType, callback) {
		 ...
		 * @param {Function} callback
		 */
		Bookmark.deleteOrBookmarkCurrentPositionForContent = function (position, duration, contentId, contentType, callback) {
			bookmark.setContentUid(contentId);
			bookmark.setContentType(contentType);
		 ...
		 * @param {Function} callback
		 */
		Bookmark.deleteBookmarkForContent = function (contentId, contentType, callback) {
			bookmark.setContentUid(contentId);
			bookmark.setContentType(contentType);
		 ...
		 * @param {Number} accountId
		 */
		proto.init = function (contentUid, type, accountId) {
		...
		proto.getCurrentBookmark = (function () {
			...
			return function (callback) {
				...
				}, this._contentUid, this._contentType, "en_gb");
