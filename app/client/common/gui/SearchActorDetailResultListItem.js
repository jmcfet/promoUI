/**
 * SearchActorDetailResultListItem is a concrete implementation of AbstractListItem and
 * represents a list item object containing a graphic and text
 * stacked in vertical formation.
 *
 * @class $N.gui.SearchActorDetailResultListItem
 * @constructor
 ...
 */
(function ($N) {
	function SearchActorDetailResultListItem(docRef) {
		$N.apps.core.Language.adornWithGetString(SearchActorDetailResultListItem, "customise/resources/");
		this._log = new $N.apps.core.Log("CommonGUI", "SearchActorDetailResultListItem");
		SearchActorDetailResultListItem.superConstructor.call(this, docRef);
	...
	$N.gui.Util.extend(SearchActorDetailResultListItem, $N.gui.AbstractListItem);

	/**
	 * Sets the width of the SearchActorDetailResultListItem.
	 * @method setWidth
	 * @param {Number} width The width of the SearchActorDetailResultListItem.
	 * @return {Object} The SearchActorDetailResultListItem object.
	 */
	SearchActorDetailResultListItem.prototype.setWidth = function (width) {
		this._width = width;
		return this;
	};
	 ...
	 */
	SearchActorDetailResultListItem.prototype.resetPositions = function () {
	 ...
	 */
	SearchActorDetailResultListItem.prototype.setPositionsForSeries = function () {
		this._date.configure({
			x: 22.5,
			y: 3,
			cssClass: "searchDetailResultListItemText"
	 ...
	 */
	SearchActorDetailResultListItem.prototype.setCssClass = function (cssClass) {
	 ...
	 * @param {Object} cssClass
	 */
	SearchActorDetailResultListItem.prototype.setHighlightCssClass = function (cssClass) {
		this._CLASS_BACKGROUND_HIGHLIGHT = cssClass || "timeListItemHighlight highlightRoundedCorner";
	};

	/**
	 * Sets the height of the SearchActorDetailResultListItem.
	 * @method setHeight The height of the SearchActorDetailResultListItem.
	 * @param {Number} height
	 * @return {Object} The SearchActorDetailResultListItem object.
	 */
	SearchActorDetailResultListItem.prototype.setHeight = function (height) {
		this._height = height;
		return this;
	};
	 ...
	 */
	SearchActorDetailResultListItem.prototype.updateHighlight = function () {
		this._log("updateHighlight", "enter");
		...
		this._log("updateHighlight", "Exit");
	};

	/**
	 * @method highlight
	 */
	SearchActorDetailResultListItem.prototype.highlight = function () {
	 ...
	 * @method unHighlight
	 */
	SearchActorDetailResultListItem.prototype.unHighlight = function () {
		this._background.setCssClass(this._CLASS_BACKGROUND);
		if (this.isHighlighted) {
			this.isHighlighted = false;
			this.updateHighlight();
	 ...
	 * @method focus
	 */
	SearchActorDetailResultListItem.prototype.focus = function () {
		this._background.setCssClass(this._CLASS_BACKGROUND_HIGHLIGHT);
		if (!this.isFocused) {
			this.isFocused = true;
			this.updateHighlight();
	 ...
	 * @method defocus
	 */
	SearchActorDetailResultListItem.prototype.defocus = function () {
		this._background.setCssClass(this._CLASS_BACKGROUND);
		if (this.isFocused) {
	...
	SearchActorDetailResultListItem.prototype.showBTVRelatedFields = function (data) {
	...
	/**
	 * Updates the data stored within the SearchActorDetailResultListItem.
	 * @method update
	 * @param {Object} data The new SearchActorDetailResultListItem data.
	 */
	SearchActorDetailResultListItem.prototype.update = function (data) {
	...
	$N.gui = $N.gui || {};
	$N.gui.SearchActorDetailResultListItem = SearchActorDetailResultListItem;
}($N || {}));
