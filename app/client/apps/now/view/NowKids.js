...
(function ($N) {
	var NowKids = function (docRef, parent) {
		NowKids.superConstructor.call(this, docRef);
		$N.apps.core.Language.importLanguageBundleForObject(NowKids, null, "apps/now/common/", "LanguageBundle.js", null, window);
		...
		this._gallery = new $N.gui.PageableList(this._docRef, this._container);
		...
		this._assetInfo = new $N.gui.NowKidsInfo(this._docRef, this._detailsGroup);
		...
		this._gallery.configure({
			...
			columns: 1,
			rows: 3,
			itemTemplate: $N.gui.NowKidsItem,
	...
	$N.gui.Util.extend(NowKids, $N.gui.GUIObject);

	/**
	 * @method selectRowByValidation
	 * @param {Function} validationFunction
	 */
	NowKids.prototype.selectRowByValidation = function (validationFunction) {
	 ...
	 */
	NowKids.prototype.setItemSelectedCallback = function (callback) {
	 ...
	 * @param {Object} data
	 */
	NowKids.prototype.setData = function (data) {
	 ...
	 * @return {Object}
	 */
	NowKids.prototype.getSelectedItem = function () {
	 ...
	 */
	NowKids.prototype.displayData = function (preview, avoidHighlight) {
	 ...
	 * @method select
	 */
	NowKids.prototype.select = function () {
	 ...
	 * @method focus
	 */
	NowKids.prototype.focus = function () {
	 ...
	 * @method defocus
	 */
	NowKids.prototype.defocus = function () {
	 ...
	 * @return {bool} handled
	 */
	NowKids.prototype.keyHandler = function (key) {
