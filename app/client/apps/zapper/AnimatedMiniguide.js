...
function AnimatedMiniguide(documentReference, parent) {
	...
	this._log = new $N.apps.core.Log('ZAPPER', 'AnimatedMiniguide');

	this._itemHighlightedTimeout = null;
	this._itemHighlightedTimeoutMS = 500;
	this._unlockOptionsShowing = false;
...
/**
 * This is non functional - it has been left in if net request this functionality
 * @method showUnlockOptions
 */
AnimatedMiniguide.prototype.showUnlockOptions = function () {
	this._log("showUnlockOptions", "Enter");
	this._unlockOptionsShowing = true;
	this._log("showUnlockOptions", "Exit");
};

/**
 * This is non functional - it has been left in if net request this functionality
 * @method hideUnlockOptions
 */
AnimatedMiniguide.prototype.hideUnlockOptions = function () {
	this._log("hideUnlockOptions", "Enter");
	this._unlockOptionsShowing = false;
	this._log("hideUnlockOptions", "Exit");
};
 ...
 */
AnimatedMiniguide.prototype.isUnlockOptionShowing = function () {
	this._log("isUnlockOptionShowing", "Enter & Exit");
	return this._unlockOptionsShowing;
};
