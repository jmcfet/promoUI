 /**
 * This module is responsible for managing application preferences
 *
 * @main
 *
 * @module platform
 ...
 * @static
 * @namespace $N.platform.system
 * @requires $N.app.system.Log
 */
...
$N.platform.system.Preferences = (function () {
	...
	return {
		 ...
		 */
		initialise: function () {
			log("initialise", "Initialising Preferences...");
		...
		set: function (preference, value, absolute) {
			var pref = absolute ? preference : parsePreference(preference),
				retValue = null;
			log("set", "path " + pref);
			//TODO:https://atlassian.hq.k.grp/jira/browse/NINJA-1749
			/*
			 * Changed the if condition to allow setting int 0 to the configman
			 */
