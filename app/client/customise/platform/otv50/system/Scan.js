...
// This file has been added to support NET ticket NO5SA-1346, and is tracked in
// the UI database as NETUI-2245 as technical debt. This file should be removed
// once the JSFW has been upgraded or the necessary patches applied.
...
// 		dvbcSVLSignalStrengthScanProfileName = "cable_signal_strength";
...
// 		if (profiles.error) {
// 			CCOM.ConfigManager.setValue("/network/siconfig/networkClasses/Cable/transponders/0/dvbc/networkId", 0);
// 			CCOM.ConfigManager.setValue("/network/siconfig/networkClasses/Cable/transponders/0/dvbc/modulation", 5);
// 			CCOM.ConfigManager.setValue("/network/siconfig/networkClasses/Cable/transponders/0/dvbc/frequency", 243000);
// 			CCOM.ConfigManager.setValue("/network/siconfig/networkClasses/Cable/transponders/0/dvbc/symbolRate", 5217);

// 			CCOM.ConfigManager.setValue("/network/siconfig/networkClasses/CableEITPFOnly/transponders/0/dvbc/networkId", 0);
// 			CCOM.ConfigManager.setValue("/network/siconfig/networkClasses/CableEITPFOnly/transponders/0/dvbc/modulation", 5);
// 			CCOM.ConfigManager.setValue("/network/siconfig/networkClasses/CableEITPFOnly/transponders/0/dvbc/frequency", 243000);
// 			CCOM.ConfigManager.setValue("/network/siconfig/networkClasses/CableEITPFOnly/transponders/0/dvbc/symbolRate", 5217);
// 		}
// 	}
...
// 				CCOM.SINetwork.unlockConfiguration();
// 				if (autoScanEnabledCallback) {
// 					autoScanEnabledCallback();
// 				}
// 			}
// 		};
...
// 		var tree = CCOM.ConfigManager.getSubtree(SCANS_PATH + dvbcSVLSignalStrengthScanProfileName);
// 		if (tree.error) {
// 			CCOM.ConfigManager.setValue(SCANS_PATH + dvbcSVLSignalStrengthScanProfileName + "/networkClass", "Cable");
// 			CCOM.ConfigManager.setValue(SCANS_PATH + dvbcSVLSignalStrengthScanProfileName + "/enabled", true);
//             CCOM.ConfigManager.setValue(SCANS_PATH + dvbcSVLSignalStrengthScanProfileName + "/persistent", true);
//             CCOM.ConfigManager.setValue(SCANS_PATH + dvbcSVLSignalStrengthScanProfileName + "/scanType", 0);
//             CCOM.ConfigManager.setValue(SCANS_PATH + dvbcSVLSignalStrengthScanProfileName + "/useConnectedTuners", false);
//             CCOM.ConfigManager.setValue(SCANS_PATH + dvbcSVLSignalStrengthScanProfileName + "/automatic", false);
// 		}
// 		var tree = CCOM.ConfigManager.getSubtree(SCANS_PATH + dvbcSVLScanProfileName);
// 		if (tree.error) {
// 			CCOM.ConfigManager.setValue(SCANS_PATH + dvbcSVLScanProfileName + "/networkClass", "CableEITPFOnly");
...
//             CCOM.ConfigManager.setValue(SCANS_PATH + dvbcSVLScanProfileName + "/scanType", 2);
...
// 	}
	...
	return {
		 ...
		 */
		// initialise : function () {
		// 	log("initialise", "Initialising Scan singleton.");
		...
		// 	autoScanEnabledCallback = callback;
		// },
		...
		// /**
		//  * Performs the named scan.
		//  * @param scanName The name of the scan to trigger.
		//  * @return TRUE if the scan could be started, FALSE otherwise.
		//  */
		// performNamedScan : function(scanName) {
		// 	log("performNamedScan", "Scan name " + scanName);
		// 	var result = null;

		// 	result = CCOM.SINetwork.scan(scanName);

		// 	if (result.error) {
		// 		log("performNamedScan", "Scan error code: " + result.error);

		// 		if (scanFailureCallback) {
		// 			log("performNamedScan", "calling scanFailureCallback");
		// 			scanFailureCallback($N.platform.system.Scan.Error.MISC_ERROR);
		// 		}

		// 		return false;
		// 	} else {
		// 		log("performNamedScan", "Scan started, scan handle " + result.scanHandle);
		// 		scanHandle = result.scanHandle;
		// 		return true;
		// 	}
